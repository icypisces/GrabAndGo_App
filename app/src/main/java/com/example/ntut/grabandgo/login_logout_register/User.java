...
public class User implements Serializable {
    ...
    public User(int rest_id, String rest_typeId, String rest_name,
                String rest_branch, String rest_address, String rest_phone,
                String rest_owner, String rest_email, String rest_username,
                String rest_passward, String rest_url, float rest_longitude,
                float rest_latitude) {
    ...
    public User(int rest_id, String rest_typeId, String rest_name,
                ...
                String rest_owner, String rest_email, String rest_username,
                String rest_passward, String rest_url, float rest_longitude,
                float rest_latitude, Blob rest_mainbanner, Blob rest_logo,
